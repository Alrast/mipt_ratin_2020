...
def draw_chum(scr, x, y, width):
    ...
    rect(surf, pink, (width // 5 + 0*width // 5, height // 6, width // 5 + 1 * width // 5 - (width // 5 + 0 * width // 5), height // 3-height // 6))
    rect(surf, yellow, (width//10 + 3*width//5, height//3, width//10 + 4*width//5 - (width//10 + 3*width//5), height // 2 - height // 3))
    rect(surf, blue, (width // 10 + 2*width // 5, height // 18,width//10 + 3*width//5 - (width//10 + 2*width//5), height // 6 - height // 18))
